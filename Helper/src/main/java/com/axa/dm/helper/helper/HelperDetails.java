...
public class HelperDetails implements java.io.Serializable {
	...
	public java.lang.Integer getAge() {
		...
		if (this.getHelperDobCal() != null) {
			i = Period.between(this.getHelperDobCal(), LocalDate.now()).getYears();
			return i;
		}
		return null;
	}
